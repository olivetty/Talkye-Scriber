...
static void my_application_activate(GApplication* application) {
  ...
  // Frameless window — Flutter draws everything including title bar and resize edges
  gtk_window_set_decorated(window, FALSE);
  gtk_window_set_title(window, "Talkye Scriber");

  // Enable RGBA visual for transparent corners
  ...
  // Background transparent for rounded corners
